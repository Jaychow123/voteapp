...
public class AdminHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminHomeActivity.this, ResultsAdminActivity.class);
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminHomeActivity.this, AddPartyActivity.class);
                startActivity(intent);
            }
        });
    ...
    public void openAddVoter() {
        Intent intent = new Intent(this, AddVoterActivity.class);
        startActivity(intent);
    }
}